 ...
 * @date    2018-04-19
 */
package org.rmj.parameter.basefx;
...
import org.rmj.parameter.pojofx.UnitModule;

public class Module implements GRecord{   
    @Override
    public UnitModule newRecord() {
        UnitModule loObject = new UnitModule();
        
        Connection loConn = null;
        loConn = setConnection();       
        
        //assign the primary values
        loObject.setModuleCode(MiscUtil.getNextCode(loObject.getTable(), "sModuleCd", false, loConn, psBranchCd));
        
        return loObject;
    }

    @Override
    public UnitModule openRecord(String fstransNox) {
        UnitModule loObject = new UnitModule();
        
        Connection loConn = null;
        loConn = setConnection();   
        
        String lsSQL = MiscUtil.addCondition(getSQ_Master(), "sModuleCd = " + SQLUtil.toSQL(fstransNox));
    ...
    @Override
    public UnitModule saveRecord(Object foEntity, String fsTransNox) {
        String lsSQL = "";
        UnitModule loOldEnt = null;
        UnitModule loNewEnt = null;
        UnitModule loResult = null;
        
        // Check for the value of foEntity
        if (!(foEntity instanceof UnitModule)) {
            setErrMsg("Invalid Entity Passed as Parameter");
            return loResult;
        }
        
        // Typecast the Entity to this object
        loNewEnt = (UnitModule) foEntity;
        
        
        // Test if entry is ok
        if (loNewEnt.getModuleName().equals("")){
        ...
        if (fsTransNox.equals("")){
            ...
            loNewEnt.setModuleCode(MiscUtil.getNextCode(loNewEnt.getTable(), "sModuleCd", false, loConn, psBranchCd));
            ...
            lsSQL = MiscUtil.makeSQL((GEntity) loNewEnt, (GEntity) loOldEnt, "sModuleCd = " + SQLUtil.toSQL(loNewEnt.getValue(1)));
        }
    ...
    public boolean deleteRecord(String fsTransNox) {
        UnitModule loObject = openRecord(fsTransNox);
        ...
        String lsSQL = "DELETE FROM " + loObject.getTable() + 
                        " WHERE sModuleCd = " + SQLUtil.toSQL(fsTransNox);
    ...
    public boolean deactivateRecord(String fsTransNox) {
        ...
        String lsSQL = "UPDATE " + loObject.getTable() + 
                        ...
                        " WHERE sModuleCd = " + SQLUtil.toSQL(loObject.getModuleCode());
    ...
    public String getSQ_Master() {
        return (MiscUtil.makeSelect(new UnitModule()));
    }
